...
<form action="../controller/action_employeeUpdate.php" method="POST" >
	<label for="empFName">First Name </label>
	<input type="text" id="empFName" name="empFName" value="" placeholder="Enter first name"  >
	<span class="error" ><?php if(isset($empFNameErr)){echo $empFNameErr;} ?></span>
	<br>
	<br>
	<label for="empLName">Last Name </label>
	<input type="text" id="empLName" name="empLName" value="" placeholder="Enter Last name" >
	<span class="error" ><?php if(isset($empLNameErr)){echo $empLNameErr;} ?></span>
	<br>
	<br>
	<label for="empUName">Username </label>
	<input type="text" id="empUName" name="empUName" value="" placeholder="Enter username" >
	...
	<input type="date" id="empBirthday" name="empBirthday" value="" >
	...
	<input type="email" id="empEmail" name="empEmail" value="" placeholder="Enter Email Address" >
	<span class="error" ><?php if(isset($empEmailErr)){echo $empEmailErr;} ?></span>
	<br>
	<br>
	<label for="empPhn">Phone Number </label>
	<input type="tel" id="empPhn" name="empPhn" value="" placeholder="" >
